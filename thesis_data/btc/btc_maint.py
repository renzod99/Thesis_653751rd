...
file_path = "thesis_data/btc/data/hyperparameter_config_t.yaml"

hyperparams, result = mml_t(train, test, kernel_str, bounds_file_path=file_path, number_of_init=5)
...
kfi = TFilterInterpreter.TFInterpreter(kf, transformation=scaler)
